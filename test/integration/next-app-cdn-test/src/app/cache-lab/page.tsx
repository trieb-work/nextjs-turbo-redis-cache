...
export default function CacheLabIndexPage() {
  return (
    <main className="mx-auto max-w-5xl p-10">
      ...
      <Link
        className="mt-4 flex items-center gap-2 rounded-lg border border-orange-200 bg-orange-50 p-5 hover:bg-orange-100"
        href="/cdn-purge"
      >
        <div>
          ...
          <p className="mt-1 text-sm text-orange-700">
            Trigger Cloudflare prefix, URL, or full-zone purge with one click.
          </p>
        </div>
      </Link>

      <Link
        className="mt-4 flex items-center gap-2 rounded-lg border border-blue-200 bg-blue-50 p-5 hover:bg-blue-100"
        href="/cdn-status"
      >
        <div>
          <h2 className="text-lg font-medium text-blue-800">CDN Status</h2>
          <p className="mt-1 text-sm text-blue-700">
            Inspect live request headers from Cloudflare — watch CF-Cache-Status
            flip from MISS to HIT.
          </p>
        </div>
      </Link>
